...
#INFORMACIÓN IMPORTANTE: DB1 Y DB4 Son copias de DB2, las originales están malas.
...
for (i in 1:cantidad_dbs){
 ...
 # print(paste('./databases/', dbb , sep="")) #DEBUGGER
